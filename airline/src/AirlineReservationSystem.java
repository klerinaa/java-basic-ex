...
public class AirlineReservationSystem {
    public static void main(String[] args) {
        ...
        while (true) {
            // User login
            User loggedInUser = loginUser(scanner, users);
            ...
            while (!logout) {
                ...
                // If the manager logs out, we set logout to true
                logout = true;
            }
        }
    }

    private static User loginUser(Scanner scanner, User[] users) {
    ...
    private static void bookFlight(Scanner scanner, Flight[][] flights) {
        ...
        if (airlineChoice >= 1 && airlineChoice <= flights.length) {
            ...
            System.out.println("Invalid airline choice. Please select a valid option.");
        }
    }
}
